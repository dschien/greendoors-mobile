...
!function ($) {
    ...
    var Validator = function (options) {
         ...
         */
        this.messages = {
            defaultMessage: "This value seems to be invalid.", type: {
                email: "This value should be a valid email.", url: "This value should be a valid url.", urlstrict: "This value should be a valid url.", number: "This value should be a valid number.", digits: "This value should be digits.", dateIso: "This value should be a valid date (YYYY-MM-DD).", alphanum: "This value should be alphanumeric.", phone: "This value should be a valid phone number."
            }, notnull: "This value should not be null.", notblank: "This value should not be blank.", required: "This value is required.", regexp: "This value seems to be invalid.", min: "This value should be greater than or equal to %s.", max: "This value should be lower than or equal to %s.", range: "This value should be between %s and %s.", minlength: "This value is too short. It should have %s characters or more.", maxlength: "This value is too long. It should have %s characters or less.", rangelength: "This value length is invalid. It should be between %s and %s characters long.", mincheck: "You must select at least %s choices.", maxcheck: "You must select %s choices or less.", rangecheck: "You must select between %s and %s choices.", equalto: "This value should be the same."
        },
    ...
    Validator.prototype = {
         ...
         */, validators: {
            notnull: function () {
                ...
                return {
                    validate: function (val, url, self) {
                        ...
                        $.ajax($.extend({}, {
                            url: url, data: data, type: self.options.remoteMethod || 'GET', success: function (response) {
             ...
             */, mincheck: function () {
                var that = this;
                return {
                    validate: function (obj, val) {
                        return that.minlength().validate(obj, val)
                    }, priority: 32
                }
            }, maxcheck: function () {
                var that = this;
                return {
                    validate: function (obj, val) {
                        return that.maxlength().validate(obj, val)
                    }, priority: 32
                }
            }, rangecheck: function () {
                var that = this;
                return {
                    validate: function (obj, arrayRange) {
                        return that.rangelength().validate(obj, arrayRange)
                    }, priority: 32
                }
            }
        }
    ...
    ParsleyUI.prototype = {
        ...
        constructor: ParsleyUI, init: function (ParsleyInstance) {
            ...
            for (var name in constraint) {
                ...
                if ('function' === typeof this.Validator.validators[ name ]) {
                    this.constraints[ name ] = {
                        name: name, requirements: constraint[ name ], valid: null
                    }
    ...
    ParsleyForm.prototype = {
        ...
        /* init data, bind jQuery on() actions */, init: function (element, options, type) {
            this.type = type;
            this.items = [];
            this.$element = $(element);
            this.options = options;
    ...
    $.fn.parsley.defaults = {
        ...
        , errors: {
            ...
            }                // specify an elem where errors will be **apened**
            ...
            }     // Executed once on form validation. Return (bool) false to block submit, even if valid
